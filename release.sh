...
echo "  *** \033[0;32mBuilding for \033[0;33mLinux x64\033[0m **"
...
echo "  *** \033[0;32mBuilding for \033[0;33mWindows 7\033[0m x64 **"
...
echo "  *** \033[0;32mZipping Linux build\033[0m **"
cd linux-build
zip -r ../nonoSharpLinux$1.zip -xi ./*

echo "  *** \033[0;32mZipping Windows build\033[0m **"
cd ../windows-build
